...
public class UrlProcessor {
    ...
    public String MERCHANTID = "105000044110067"; // 商户代码
    public String POSID = "035839543"; // 商户柜台代码
    public String BRANCHID = "330000000"; // 分行代码
    public String PUB32TR2 = "b0d4a2a25199c36319983bf9020111";
    ...
    public String make(CcbAccountBean accountBean, String price, String originOrderNo, String orderId) {
        String tmp;
        String tmp0;
        String temp_New1 = "", urlResult = "";
        PAYMENT = price;
        ORDERID = orderId;
        REMARK1 = originOrderNo;
        if(accountBean != null){
            MERCHANTID = accountBean.getMerchantId();
            POSID = accountBean.getPosId();
            BRANCHID = accountBean.getBankId();
            PUB32TR2 = accountBean.getPubNo();
            PUB32TR2 = PUB32TR2.substring(PUB32TR2.length()-30, PUB32TR2.length());
            INSTALLNUM = accountBean.getInstallNum();
        }
        ...
        if ("3".equals(index)) {
            ...
            temp_New += "&THIRDAPPINFO=CCBPayZiubao";
...
//        Log.e("---商户参数串---", temp_New);
        ...
        String URL3 = temp_New1 + "&MAC="
                + Util.getInstance().hex_md5(temp_New) + "&CallJs=0";
