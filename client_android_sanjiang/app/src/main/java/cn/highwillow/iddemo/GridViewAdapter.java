    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (position){
                    case 0://高亭
                        mContext.startActivity(new Intent(mContext,MainActivity.class).putExtra("url","http://221.12.158.166:9099/gtjp/"));
                        break;
                    case 1://秀山
                        mContext.startActivity(new Intent(mContext,MainActivity.class).putExtra("url","http://221.12.158.166:9099/xsjp/"));
                        break;
                    case 2://长涂
                        mContext.startActivity(new Intent(mContext,MainActivity.class).putExtra("url","http://221.12.158.166:9099/ctjp/"));
                        break;
                    case 3://衢山
                        mContext.startActivity(new Intent(mContext,MainActivity.class).putExtra("url","http://221.12.158.166:9099/qsjp/"));
                        break;
                    case 4://小洋山
                        mContext.startActivity(new Intent(mContext,MainActivity.class).putExtra("url","http://221.12.158.166:9099/xysjp/"));
                        break;
                    case 5://嵊泗
                        mContext.startActivity(new Intent(mContext,MainActivity.class).putExtra("url","http://221.12.158.166:9099/ssjp/"));
                        break;
                }
            }
        });
